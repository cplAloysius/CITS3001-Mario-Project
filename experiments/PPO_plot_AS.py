...
# Create bars
plt.bar(r1, as1, width = barWidth, edgecolor = 'grey', label='1e-6 Learning Rate')
plt.bar(r2, as2, width = barWidth, edgecolor = 'grey', label='1e-4 Learning Rate')
...
plt.title("Average Score for each time step", fontweight='bold')
